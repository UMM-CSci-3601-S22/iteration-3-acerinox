...
public class ProductControllerPutSpec {
    ...
    public void setupEach() throws IOException {
        ...
        testProducts.add(
                new Document()
                        ...
                        .append("tags", new ArrayList<String>(Arrays.asList(new String[] { "yellow fruit", "potassium" })))
                        .append("lifespan", 4)
                        .append("threshold", 40));
        testProducts.add(
                new Document()
                        ...
                        .append("image", "https://gravatar.com/avatar/8c9616d6cc5de638ea6920fb5d65fc6c?d=identicon")
                        .append("notes", "I eat these with toothpaste, yum-yum.")
                        .append("tags", new ArrayList<String>(Arrays.asList(new String[] { "canned food", "non-perishable", "beans" })))
                        .append("lifespan", 4)
                        .append("threshold", 4));
        testProducts.add(
                new Document()
                        ...
                        .append("image", "https://gravatar.com/avatar/8c9616d6cc5de638ea6920fb5d65fc6c?d=identicon")
                        .append("notes", "I eat these with toothpaste, yum-yum.")
                        .append("tags", new ArrayList<String>(Arrays.asList(new String[] { "Yeast", "contains gluten", "toast" })) )
                        .append("lifespan", 2)
                        .append("threshold", 3));
        testProducts.add(
                new Document()
        ...
        Document milk = new Document()
                ...
                .append("tags", new ArrayList<String>(Arrays.asList(new String[] { "dairy", "perishable", "cold storage" })))
                .append("lifespan", 4)
                .append("threshold", 2);
    ...
    public void testEditingItem() {
        ...
        String testNewProduct = "{"
                ...
                + "\"brand\": \"test brand\","
                + "\"category\": \"test category\"," // Invalid category
                + "\"store\": \"test store\","
